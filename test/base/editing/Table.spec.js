...
describe("base:editing.Table", () => {
  ...
  describe("tableWorker", () => {
    ...
    it("should delete simple 1x1 table", () => {
      var $cont = $(
        '<div class="note-editable"><table><tr><td>content</td></tr></table></div>'
      );
    ...
    it("should add simple row to table on top", () => {
      ...
      expect(
        "<table><tbody><tr><td><br></td></tr><tr><td>content</td></tr></tbody></table>"
      ).to.equalsIgnoreCase($cont.html());
    });
    ...
    it("should add simple row to table on bottom", () => {
      ...
      expect(
        "<table><tbody><tr><td>content</td></tr><tr><td><br></td></tr></tbody></table>"
      ).to.equalsIgnoreCase($cont.html());
    });
    ...
    it("should add simple row to table on top between two rows", () => {
      ...
      table.addRow(rng, "top");
      var resultTable = $(
        "<table><tbody><tr><td>content1</td></tr></tbody></table>"
      );
    ...
    it("should add simple row to table on bottom between two rows", () => {
      var baseTable = $(
        '<table><tbody><tr><td id="td1">content1</td></tr></tbody></table>'
      );
      $(baseTable).append('<tr><td id="td2">content2</td></tr>');
      var htmlContent =
        '<div class="note-editable"><table>' +
        $(baseTable).html() +
        "</table></div>";
      var $cont = $(htmlContent);
    ...
    it("should add simple col to table on left between two cols", () => {
      ...
      var baseTr =
        '<tr><td id="td1">content1</td><td id="td2">content2</td></tr>';
      ...
      $(resultTable).append(
        '<tr><td id="td1">content1</td><td><br/></td><td id="td2">content2</td></tr>'
      );
      var expectedResult = "<table>" + $(resultTable).html() + "</table>";
    ...
    it("should delete row to table between two other rows", () => {
      ...
      var resultTable = $("<table><tbody></tbody></table>");
      $(resultTable).append(
        '<tr><td id="td1">content1</td></tr><tr><td id="td3">content3</td></tr>'
      );
      var expectedResult = "<table>" + $(resultTable).html() + "</table>";
    ...
    it("should delete col to table between two other cols", () => {
      var baseTable = $("<table><tbody></tbody></table>");
      var baseTr =
        '<tr><td id="td1">content1</td><td id="td2">content2</td><td id="td3">content3</td></tr>';
      baseTable.append(baseTr);
      var htmlContent =
        '<div class="note-editable"><table>' +
        $(baseTable).html() +
      ...
      var resultTable = $("<table><tbody></tbody></table>");
      $(resultTable).append(
        '<tr><td id="td1">content1</td><td id="td3">content3</td></tr>'
      );
      var expectedResult = "<table>" + $(resultTable).html() + "</table>";
    ...
    it("should delete first col to table with colspan in column with colspan", () => {
      var baseTable = $("<table><tbody></tbody></table> ");
      var baseTr1 =
        '<tr><td colspan="2" id="tr1td1">Col1-Span</td><td id="tr1td2">Col2</td></tr>';
      var baseTr2 =
        '<tr><td id="tr2td1">Col1</td><td id="tr2td2">Col2</td><td id="tr2td3">Col3</td></tr>';
      ...
      var resultTr2 =
        '<tr><td id="tr2td2">Col2</td><td id="tr2td3">Col3</td></tr>';
    ...
    it("should delete second col to table with colspan in column", () => {
      ...
      var resultTable = $("<table><tbody></tbody></table> ");
      var resultTr1 =
        '<tr><td id="tr1td1">Col1-Span</td><td id="tr1td2">Col2</td></tr>';
      var resultTr2 =
        '<tr><td id="tr2td1">Col1</td><td id="tr2td3">Col3</td></tr>';
      resultTable.append(resultTr1);
      resultTable.append(resultTr2);
      var expectedResult = "<table>" + $(resultTable).html() + "</table>";
    ...
    it("should delete second col to table with colspan in 3 columns", () => {
      var baseTable = $("<table><tbody></tbody></table> ");
      var baseTr1 =
        '<tr><td colspan="3" id="tr1td1">Col1-Span</td><td id="tr1td4">Col4</td></tr>';
      var baseTr2 =
      ...
      var resultTable = $("<table><tbody></tbody></table> ");
      var resultTr1 =
        '<tr><td colspan="2" id="tr1td1">Col1-Span</td><td id="tr1td4">Col4</td></tr>';
      var resultTr2 =
        '<tr><td id="tr2td1">Col1</td><td id="tr2td3">Col3</td><td id="tr2td4">Col4</td></tr>';
      resultTable.append(resultTr1);
      resultTable.append(resultTr2);
      var expectedResult = "<table>" + $(resultTable).html() + "</table>";
    ...
    it("should delete first row to table with rowspan in line with rowspan", () => {
      ...
      var resultTable = $("<table><tbody></tbody></table> ");
      var resultTr1AndTr2 =
        '<tr><td class="test" id="tr1td1"></td><td id="tr2td2">Col2</td></tr>';
      var resultTr3 =
        '<tr><td id="tr3td1">Col1</td><td id="tr3td2">Col2</td></tr>';
    ...
    it("should delete second row to table with rowspan in line without rowspan", () => {
      ...
      var resultTable = $("<table><tbody></tbody></table>");
      var resultTr1 =
        '<tr><td rowspan="2" id="tr1td1">Row1-Span</td><td id="tr1td2">Col2</td></tr>';
    ...
    it("should add row on bottom rowspan cell.", () => {
      ...
      var resultTable = $("<table><tbody></tbody></table> ");
      var resultTr1 =
        '<tr><td rowspan="3" id="tr1td1">Col1-Span</td><td id="tr1td2">Col2</td></tr>';
    ...
    it("should add column on right having rowspan cell and with aditional column.", () => {
      ...
      var resultTable = $("<table><tbody></tbody></table> ");
      var resultTr1 =
        '<tr><td rowspan="2" id="tr1td1">Col1-Span</td><td id="tr1td2">Col2</td><td><br></td></tr>';
    ...
    it("should remove column after colspan column.", () => {
      ...
      var resultTable = $("<table><tbody></tbody></table> ");
      var resultTr1 =
        '<tr><td id="tr1td1">Col1</td><td colspan="2" id="tr1td2">Col2-Span</td></tr>';
      var resultTr2 =
        '<tr><td id="tr2td1">Col1</td><td id="tr2td2">Col2</td><td id="tr2td3">Col3</td></tr>';
      resultTable.append(resultTr1);
      resultTable.append(resultTr2);
    ...
    it("should remove column before colspan column.", () => {
      var baseTable = $("<table><tbody></tbody></table> ");
      var baseTr1 =
        '<tr><td id="tr1td1">TR1TD1</td><td id="tr1td2" colspan="2">TR1TD2-COLSPAN</td>';
      baseTr1 += '<td id="tr1td4">TR1TD4</td></tr>';
      var baseTr2 =
        '<tr><td id="tr2td1">TR2TD1</td><td id="tr2td2">TR2TD2</td><td id="tr2td3">TR2TD3</td>';
      ...
      var resultTr2 =
        '<tr><td id="tr2td2">TR2TD2</td><td id="tr2td3">TR2TD3</td><td id="tr2td4">TR2TD4</td></tr>';
      resultTable.append(resultTr1);
      resultTable.append(resultTr2);
      var expectedResult = "<table>" + $(resultTable).html() + "</table>";
    ...
    it("should add column before colspan column.", () => {
      var baseTable = $("<table><tbody></tbody></table> ");
      var baseTr1 =
        '<tr><td id="tr1td1">TR1TD1</td><td id="tr1td2">TR1TD2</td></tr>';
      ...
      var resultTable = $("<table><tbody></tbody></table> ");
      var resultTr1 =
        '<tr><td id="tr1td1">TR1TD1</td><td><br></td><td id="tr1td2">TR1TD2</td></tr>';
