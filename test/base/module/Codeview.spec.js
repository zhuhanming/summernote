...
describe("Codeview", () => {
  ...
  it("should show CodeMirror if available", (done) => {
    var codemirror = loadScript(
      "https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.41.0/codemirror.js"
    );
  ...
  it("should purify malicious codes", () => {
    expect(
      codeview.purify('<script>alert("summernote");</script>')
    ).to.equalsIgnoreCase('alert("summernote");');
    expect(
      codeview.purify(
  ...
  it("should purify can be customized", () => {
    ...
    expect(
      codeview.purify('<script>alert("summernote");</script>')
    ).to.equalsIgnoreCase('<script>alert("summernote");</script>');
