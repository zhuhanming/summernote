...
describe("Editor", () => {
  ...
  function expectContentsAwait(context, markup, done) {
    expect(context.layoutInfo.editable.html())
      .await(done)
      .to.equalsIgnoreCase(markup);
  }
  ...
  describe("indent and outdent", () => {
    ...
    it("should indent and outdent paragraph", (done) => {
      ...
      expectContentsChain(
        ...
        () => {
          editor.outdent();
          expect($editable.find("p").css("margin-left")).await(done).to.be
            .empty;
        }
      );
    });
    ...
    it("should indent and outdent list", (done) => {
      ...
      expectContentsChain(context, "<ol><li>hello</li></ol>", () => {
        ...
        expectContentsChain(
          context,
          "<ol><li><ol><li>hello</li></ol></li></ol>",
          () => {
            editor.indent();
            expectContentsChain(
              context,
              "<ol><li><ol><li><ol><li>hello</li></ol></li></ol></li></ol>",
              () => {
                editor.outdent();
                expectContentsChain(
                  context,
  ...
  describe("setLastRange", () => {
    it("should set last range", (done) => {
      ...
      expect(editor.lastRange.sc)
        .await(done)
        .to.equal(editor.editable.lastChild);
    });
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              expectContentsAwait(
                context,
                "<p><span> world</span><span> hello</span>hello</p>",
                done
              );
            }, 10);
          }, 10);
  ...
  describe("pasteHTML", () => {
    ...
    it("should not add empty paragraph", (done) => {
      editor.pasteHTML(
        "<p><span>whatever</span><br></p><p><span>it has</span><br></p>"
      );
      expectContentsAwait(
        context,
        "<p>hello</p><p><span>whatever</span><br></p><p><span>it has</span><br></p>",
        done
      );
    });
  ...
  describe("formatBlock", () => {
    ...
    it("should apply custom className in formatBlock", (done) => {
      ...
      expectContentsAwait(
        context,
        '<h4 class="customH4Class">hello</h4>',
        done
      );
    });
    ...
    it("should find exact target in formatBlock", (done) => {
      ...
      expectContentsAwait(
        context,
        '<h6 class="customH6Class">hello</h6>',
        done
      );
    });
    ...
    it("should add fontSize to block", (done) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          expectContents(
            context,
            '<p><span style="font-size: 20px;">﻿</span>hello</p>'
          );
          done();
        });
      });
  ...
  describe("createLink", () => {
    it("should create normal link", (done) => {
      ...
      range
        .create(textNode, startIndex, textNode, endIndex)
        .normalize()
        .select();
      ...
      expectContentsAwait(
        context,
        '<p>hello<a href="http://summernote.org">summernote</a></p>',
        done
      );
    });
    ...
    it("should create a link with range", (done) => {
      ...
      expectContentsAwait(
        context,
        '<p><a href="http://summernote.org">summernote</a></p>',
        done
      );
    });
    ...
    it("should create a link with isNewWindow", (done) => {
      ...
      expectContentsAwait(
        context,
        '<p><a href="http://summernote.org" target="_blank">summernote</a></p>',
        done
      );
    });
    ...
    it("should create a relative link without scheme", (done) => {
      ...
      expectContentsAwait(
        context,
        '<p><a href="/relative/url" target="_blank">summernote</a></p>',
        done
      );
    });
    ...
    it("should modify a link", (done) => {
      ...
      expectContentsAwait(
        context,
        '<p><a href="http://wow.summernote.org">summernote wow</a></p>',
        done
      );
    });
    ...
    it("should be limited when modifying a link", (done) => {
      ...
      options.maxTextLength = 5;
      context = new Context(
        $('<p><a href="http://summernote.org">hello</a></p>'),
        options
      );
      ...
      expectContentsAwait(
        context,
        '<a href="http://summernote.org">hello</a>',
        done
      );
    });
  });
