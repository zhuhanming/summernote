...
var popover = renderer.create(['<div class="note-popover popover show">', '<div class="popover-arrow"></div>', '<div class="popover-content note-children-container"></div>', "</div>"].join(""), function ($node, options) {
